...
function Clinic({ back }: { back: () => void }) {
  ...
  const selectedRescheduleAppointment = allActiveAppointments.find(item => item.id === Number(rescheduleAppointmentId));
